    ...
    return(
        <div>
            ...
            <ColumnsWrapper>
                <Column>
                <div>
                    <Title>Pro anywhewre</Title>
                    <Desc>ijophsipuohjspiorjgoijksopijkaopåigjk apåoekf aåpoka ergåpoaer jaergåopiaejrg åppaegaj</Desc>
                    <ButtonsWrapper>
                        <Button><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                ...
                                Read More</Button>
                        <Button pink><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
